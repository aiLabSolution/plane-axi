...
export const COMMAND_METADATA = {
  ...
  "wi search": spec("Search work items in the selected project", "plane-axi wi search <query> [--project <ref>|--workspace] [--limit <n>|--all]", commands.wiSearch, {
  ...
  }, ["query..."], ["plane-axi wi search authentication bug", "plane-axi wi search onboarding --all", "plane-axi wi search onboarding --workspace"]),
